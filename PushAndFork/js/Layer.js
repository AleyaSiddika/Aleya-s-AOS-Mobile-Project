...
var Layer = {
  create: function(container, tiles, room, extra_class) {
    ...
    if (extra_class){
    var line = $("<div class='layer-line'><img src='./img/dpad.png' width='65' height='65' alt='dpad'><img src='./img/transparent.png' width='345' height='65' alt='transparent'><img src='./img/reload.png' width='40' height='40' alt='reload' margin-bottom='40px'><img src='./img/interact.png' width='45' height='45' alt='interact'></div>");
      line.css('width', (room.w * 63) + 'px');
      element.append(line);
      lines.push(line);
   }
